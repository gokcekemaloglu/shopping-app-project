    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li className="nav-item">
            <NavLink style={({isActive})=>({textDecoration: isActive && "underline"})} class="nav-link" to="/products">
              Product List
            </NavLink>            
          </li>
          <li className="nav-item">
            <NavLink style={({isActive})=>({textDecoration: isActive && "underline"})} class="nav-link" to="/about">
              About
            </NavLink>
          </li>
        </ul>        
